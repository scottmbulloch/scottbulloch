...
function rollin(id){
  ...
  switch(id){
	...
	case 'equilibrium': roller.style.background = 'transparent url(img/sidebar/equilibrium.jpg) 0px -70px no-repeat'; break;
...
function rollout(id){
  ...
  switch(id){
	...
	case 'equilibrium': roller.style.background = 'transparent url(img/sidebar/equilibrium.jpg) 0px 0px no-repeat'; break;
