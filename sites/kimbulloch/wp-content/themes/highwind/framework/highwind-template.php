...
function highwind_credit() {
	?>
		<p class="contact-email">Contact Kim directly for more information or to schedule an appointment: KimBulloch@<span>null</span>gmail.com</p>
		<ul class="social-links">
			<li><a class="facebook" href="https://www.facebook.com/kim.brownbulloch">Facebook</a></li>
			<li><a class="instagram" href="https://instagram.com/kimbulloch">Instagram</a></li>
		</ul>
	<?php
}
